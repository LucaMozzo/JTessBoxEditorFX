...
import com.github.tessboxeditor.utilities.ImageUtils;
import com.github.tess4j.util.ImageIOHelper;
import static com.github.tessboxeditor.utilities.Utils.deriveFont;
import com.github.vietocr.util.Utils;
...
public class TiffBoxGeneratorFX {
    ...
    public TiffBoxGeneratorFX(List<List<String>> textPages, Font font, int width, int height) {
        ...
        this.font = com.github.tessboxeditor.utilities.Utils.deriveFont(font, font.getSize() * 4); // adjustment
        this.width = width;
        this.height = height;
